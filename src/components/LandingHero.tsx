  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("https://images.unsplash.com/photo-1500673922987-e212871fec22?ixlib=rb-4.0.0&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80")',
        }}
      >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        <h1 className="font-playfair text-4xl md:text-6xl lg:text-7xl text-white mb-6 animate-fade-in">
          From the Heart of Nepal to the Streets of London
        </h1>
        <p className="font-inter text-lg md:text-xl text-gray-200 max-w-3xl mb-12 animate-fade-in">
          Chillo Piro & Himalayan Momo – A Journey of Flavor, Culture & Storytelling
        </p>
        <Link
          to="/home"
